...
5. **符文自動配裝** — 選怪＋選 4件套 / 2件套＋各洞主屬，引擎從符文池挑最佳解、湊套裝、算效率與符文加成合計；可勾選是否納入全帳號符文。**配裝後最終體質**：以怪物體質(BASE_STATS，來源 SWARFARM 6★滿級) 套上該組符文的主/前/副屬(%＋固定值)＋套裝%加成，算出 HP/ATK/DEF/SPD/暴率/暴傷/抵抗/命中 的「基礎值 → 最終值」對照（未計入領導技/塔/神器/銘刻）。
